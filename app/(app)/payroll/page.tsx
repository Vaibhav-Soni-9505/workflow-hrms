...
import { Umbrella, Shield, Users, FileText } from "lucide-react";
    ...
    <div className="px-4 pt-3 pb-28 space-y-5 animate-fade-in">
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <h1 className="text-2xl font-black text-foreground">Payroll</h1>
        ...
        >
          ...
          {isEmployee ? "My Payroll" : roleLabel}
        </div>
      </div>
      ...
      {role === "Admin" ? (
        <div className="glass-card rounded-2xl p-6 text-center border border-border/40">
          ...
          <p className="text-xs text-foreground-muted mt-1">
            Switch to Employee, Manager, or HR role to access payroll management.
          </p>
        </div>
      ) : (
        <PayrollModule />
